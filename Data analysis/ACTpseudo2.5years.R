...
# By Nevo et al.
# for interval length of 2.5 years
...
times <- seq(67.5, 100, 2.5)
smooth.aux <- mgcv::smooth.construct.ps.smooth.spec(mgcv::s(times,bs="ps", k = 10), 
